...
AI <- as.data.frame(coh.last[,c("AI.mean")])
...
write.csv(lm.rich.all, "../2.DX2013_145sites/data/lm.p.value.AI.mean.coh.CV.Asy.csv")
...
ggplot(coh.last, aes(x=AI.mean, y=value, color = Group))+ 
  geom_point(size = 2)+
...
ggsave("../2.DX2013_145sites/figures/AI.mean.cohesion.CV.Asy.last.pdf",
       width = 6.5, height = 5)
