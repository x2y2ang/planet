...
CV.Asy.all = read.csv("../2.DX2013_145sites/data/Total.cohesion.plant184.soil.microbial.1314.CV.Asy.aridity.gp.csv",
                      row.names = 1)
...
ggsave("../2.DX2013_145sites/figures/Aridity.total.coh.micro.plant.soil.1314.rich.Asy.9site.pdf",
       width = 6.5, height = 3)
