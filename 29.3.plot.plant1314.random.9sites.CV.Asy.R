...
prec.hori.all = read.csv("../2.DX2013_145sites/data/plant.rich.1314.CV.Asy.precipitation.delete.5200.csv")
...
# lm.T1 = prec.hori.all$Group %in% c("C")
lm.F1 = prec.hori.all$Group %in% c("A", "B", "C", "D")
...
pdf("../2.DX2013_145sites/figures/Fig.74.prec.plant1314.pca1.Asy.9site.pdf",
    width = 6.5, height = 3)
