...
################    loop for 10 eles    ######################
vec.tmp = cbind(cli188, veg.div1314, envi188)
...
vec43 = subset(vec.tmp, Elevation == 4300)

write.csv(vec43, "../2.DX2013_145sites/data/plant.4300.diversity.csv")

plant.rich.tmp = data.frame(vec.tmp.de[, "comm.richness"])
...
for (i in 1:length(ele)){
  ele.tmp <- ele[i]
  plant.t <- plant.rich.tmp[which(vec.tmp.de$Elevation == ele.tmp),]
...
write.csv(hori.all, "../2.DX2013_145sites/data/plant.pca1.1314.CV.Asy.elevation.csv")
...
ggsave("../2.DX2013_145sites/figures/Fig.69.plant1314.rich.CV.9site.pdf",
       width = 6.5, height = 3)
...
write.csv(prec.hori.all, "../2.DX2013_145sites/data/plant.rich.1314.CV.Asy.precipitation.csv")
...
ggsave("../2.DX2013_145sites/figures/Fig.70.prec.plant1314.rich.CV.9site.pdf",
       width = 6.5, height = 3)
...
write.csv(AI.hori.all, "../2.DX2013_145sites/data/plant.rich.1314.CV.Asy.aridity.csv")
...
ggsave("../2.DX2013_145sites/figures/Fig.71.Aridity.plant1314.rich.Asy.9site.pdf",
    width = 6.5, height = 3)
