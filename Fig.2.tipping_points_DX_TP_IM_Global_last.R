...
CV.Asy = read.csv("../2.DX2013_145sites/data/Tipping_point_DX_InnerMongolia_World_drylands_sites.csv")
...
ggsave("../2.DX2013_145sites/final.figures2023/Fig.2.tipping_points_DX_TP_IM_Global6.pdf",
       height=3.5, width=6.5)

ggsave("../2.DX2013_145sites/final.figures2023/Fig.2.tipping_points_DX_TP_IM_Global_legend.pdf",
