...
ele.hori.all = read.csv("../2.DX2013_145sites/data/plant.micro.rich.soil.pca1.1314.CV.Asy.elevation.de.5200.csv")
...
ele <- as.data.frame(ele.hori.all[,c("Act.ele")])
...
ggplot(ele.hori.all, aes(x=Act.ele, y=value, color = Elevation))+
  geom_point(size = 3)+
  # linear lm sig==T
...
ggsave("../2.DX2013_145sites/figures/Actual.elevation.micro.plant.soil.1314.rich.Asy.9site.pdf",
    width = 6.5, height = 5)
