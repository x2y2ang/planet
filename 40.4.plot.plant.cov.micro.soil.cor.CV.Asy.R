...
library(cowplot)
plot_grid(p5,p6,p1,p2,p3,p4)
ggsave("../2.DX2013_145sites/figures/pre.aridity.1314year.plant.cover.micro.soil.decey.cor.CV.Asy2.pdf",
       width = 10, height = 5)

#### no legend ###
plot_grid(p5,p1,p3,p6,p2,p4)
ggsave("../2.DX2013_145sites/figures/pre.AI.1314year.plant.cover.micro.soil.decey.cor.CV.Asy.no.legend.pdf",
         width = 6.5, height = 5)
