...
PV.all = read.csv("../2.DX2013_145sites/data/69.9.DX1314.pv.rep5000times.mean.se.add.group.true.form.csv")
...
write.csv(lm.rich.all, "../2.DX2013_145sites/data/lm.p.value.AGB.PLFA.EF.rich.soil.PV.rep5000times.csv")
...
ggsave("../2.DX2013_145sites/figures/plot.AGB.PLFA.EF.rich.soil.PV.rep5000times.pdf",
       width = 6.5, height = 5)
