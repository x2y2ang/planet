...
# aridity < 0.69
envi0.69down = subset(envi188, Elevation > "4700")

veg.shift = veg.shift[rownames(envi0.69down), ]
micro188 = micro188[rownames(envi0.69down), ]
envi188.select = envi188.select[rownames(envi0.69down), ]
...
write.table(z, '../2.DX2013_145sites/data/micro188_veg.shift_envi188.select_corr.matrix4800-5200.txt', col.names = NA, sep = '\t', quote = FALSE)
...
write.graph(g, '../2.DX2013_145sites/data/57.microbial-plant-envi.4800-5200.network.gml', format = 'gml')

write.graph(g, '../2.DX2013_145sites/data/57.gephi.microbial-plant-envi.4800-5200.network.graphml', 
            format = 'graphml')
...
write.csv(taxa.net2, "../2.DX2013_145sites/data/58.microbial.4800-5200.network.node.csv")

z.sp.env = z.taxa[c(812:829), ]

write.csv(z.sp.env, "../2.DX2013_145sites/data/58.plant-envi.4800-5200.network.node.csv")
