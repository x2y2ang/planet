...
BI.all = read.csv("../2.DX2013_145sites/data/65.Bipattite.plant.microbes.8replicates.attribute.all.last.csv")
colnames(BI.all)
...
write.csv(Bi.mean, "../2.DX2013_145sites/final.figures2023/Bipattite.plant.microbes.mean.8replicates.attribute.all.last.csv")

write.csv(Bi.se.la, "../2.DX2013_145sites/final.figures2023/Bipattite.plant.microbes.se.last.8replicates.attribute.all.last.csv")
...
ggsave("../2.DX2013_145sites/final.figures2023/Figure.plot.raw.nonliner.Bipartite.8replicates.plant.microbial.AI.patterns.pdf",
       width = 8, height = 7.5)
...
write.csv(BI.me1, "../2.DX2013_145sites/data/66.Bipartite.8replicates.all1.delete.some.attri.all.csv")


BI.me1.la = read.csv("../2.DX2013_145sites/data/67.Bipartite.8replicates.all1.delete.some.attri.all.add.group.csv",
                     row.names = 1)
...
write.csv(lm.rich.all, "../2.DX2013_145sites/data/68.lm.qu.Bipartite.8replicates.plant.microbial.AI.4replictes.csv")
...
ggsave("../2.DX2013_145sites/final.figures2023/Figure.plot.Bipartite.8replicates.plant.microbial.AI.patterns.pdf",
       width = 8, height = 7.5)
