...
PV.all.last = read.csv("../data/GCB/DX1314.pv.rep5000times.mean500row.add.group.deal.with.PLFA.csv")
...
write.csv(lm.rich.all, "../data/GCB/lm.p.value.AGB.PLFA.EF.rich.soil.PV.csv")
...
ggsave("../GCB_Figure/Fig.S4.plot.AGB.PLFA.EF.rich.soil.PV.pdf",
       width = 6.5, height = 5)
