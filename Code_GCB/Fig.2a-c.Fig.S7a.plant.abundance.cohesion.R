...
net.all = read.csv("../data/GCB/plant1314.188sites.coverage.cohesion.all.melt.gp.csv",
                   row.names = 1)
...
write.csv(lm.rich.all, "../data/GCB/lm.p.value.plant1314.coh.csv")
...
ggsave("../GCB_Figure/Fig.2a-c.Fig.S7a.plant1314.cohesion.AI.patterns.pdf",
       width = 4.5, height = 5)
