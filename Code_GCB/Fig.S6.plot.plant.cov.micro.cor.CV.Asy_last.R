...
micro.soil.all = read.csv("../data/GCB/soil.micro.decay.last.add.CV.Asy.pre.AI.csv")

plant.all = read.csv("../data/GCB/plant.coverage.last.add.CV.Asy.pre.AI.csv")
...
ggsave("../GCB_Figure/Fig.S16.Micro.decay.Micro.Rich.CV.legend.pdf",
       width = 4.5, height = 3)
...
ggsave("../GCB_Figure/Fig.S16.1314year.plant.cover.micro.soil.decey.cor.CV.Asy.no.legend.pdf",
       width = 6.5, height = 5)
