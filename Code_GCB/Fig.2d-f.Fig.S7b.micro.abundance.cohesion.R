...
net.all = read.csv("../data/GCB/micro.cohesion.last1314.group.csv")
...
write.csv(lm.rich.all, "../data/GCB/lm.p.value.micro1314.coh.csv")
...
ggsave("../GCB_Figure/Fig.2d-f.Fig.S7b.micro1314.cohesion.AI.patterns.pdf",
       width = 4.5, height = 5)
