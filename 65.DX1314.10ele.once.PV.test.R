...
write.csv(plant.rich.PV, "../2.DX2013_145sites/data/65.2.PV.Test.plant.rich.csv")
...
write.csv(Micro.rich.PV, "../2.DX2013_145sites/data/65.3.PV.Test.Micro.rich.csv")
...
write.csv(EMF.PV, "../2.DX2013_145sites/data/65.4.PV.Test.EMF.csv")
...
write.csv(AGB.PV, "../2.DX2013_145sites/data/65.5.PV.Test.AGB.csv")
...
write.csv(PLFA.PV, "../2.DX2013_145sites/data/65.6.PV.Test.PLFA.csv")
...
write.csv(Soil.pca1.PV, "../2.DX2013_145sites/data/65.7.PV.Test.Soil.pca1.csv")
