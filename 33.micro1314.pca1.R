...
################    loop for 10 eles    ######################
vec.tmp = cbind(micro.pcoa, cli1314.last, envi1314)

micro.PCoA1.tmp = data.frame(vec.tmp[, "PCoA1"])
...
for (i in 1:length(ele)){
  ele.tmp <- ele[i]
  PCoA1.t <- micro.PCoA1.tmp[which(vec.tmp$Elevation == ele.tmp),]
...
write.csv(hori.all, "../2.DX2013_145sites/data/all.micro.PCoA1.1314.CV.Asy.elevation.csv")
...
ggsave("../2.DX2013_145sites/figures/all.micro1314.PCoA1.CV.9site.AI.pdf",
       width = 6.5, height = 3)
...
write.csv(prec.hori.all, "../2.DX2013_145sites/data/all.micro.PCoA1.1314.CV.Asy.precipitation.csv")
...
ggsave("../2.DX2013_145sites/figures/all.prec.micro1314.PCoA1.CV.9site.AI.pdf",
       width = 6.5, height = 3)
...
pdf("../2.DX2013_145sites/figures/all.prec.micro1314.PCoA1.CV.9site.all.tipping.pdf",
    width = 5, height = 3)
# edge distance 
...
pdf("../2.DX2013_145sites/figures/all.prec.micro1314.PCoA1.Asy.9site.all.tipping.pdf",
    width = 6.5, height = 3)
# edge distance 
par(mar=c(4.5,4.5,4.5,4.5))
...
write.csv(AI.hori.all, "../2.DX2013_145sites/data/all.micro.PCoA1.1314.CV.Asy.aridity.csv")

# AI.hori.all = read.csv("../2.DX2013_145sites/data/micro.PCoA1.1314.CV.Asy.aridity.csv")
...
ggsave("../2.DX2013_145sites/figures/all.Aridity.micro1314.PCoA1.Asy.9site.pdf",
    width = 6.5, height = 3)
