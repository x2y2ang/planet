...
envi188 = envi1314[rownames(veg.mv),]

envi188.select = envi188[, c(11:19)]

envi.veg.micro = cbind(envi188.select, veg.mv, micro188)

envi.veg.micro1 = as.numeric(unlist(envi.veg.micro))

envi.veg.micro2 = data.frame(envi.veg.micro1)

####  for micro #####
otu = envi.veg.micro

class(envi.veg.micro)
...
occor<-rcorr(as.matrix(as.data.frame(lapply(envi.veg.micro, as.numeric))), 
                       type = "spearman")
...
write.csv(output$`Negative Cohesion`, "../2.DX2013_145sites/data/envi.plant.micro1314.Negative.cohesion.csv")
write.csv(output$`Positive Cohesion`, "../2.DX2013_145sites/data/envi.plant.micro1314.Positive.cohesion.csv")


#### plot ####
cli188 = cli1314.last[rownames(envi.veg.micro), ]
...
write.csv(AI.coh, "../2.DX2013_145sites/data/envi.plant.micro1314.cohesion.combine.with.AI.csv")
