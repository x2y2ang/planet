...
#### DX1314.pv.rep5000times.mean500row deal with PLFA ###

PV.all.last = read.csv("../2.DX2013_145sites/data/70.2.DX1314.pv.rep5000times.mean500row.add.group.deal.with.PLFA.csv")
...
write.csv(lm.rich.all, "../2.DX2013_145sites/data/lm.p.value.scatter.dot.deal.with.PLFA.DX1314.pv.rep5000times.mean500row.csv")
...
ggsave("../2.DX2013_145sites/figures/deal.with.PLFA.sactter.dot.plot.AGB.PLFA.EF.rich.soil.PV.rep5000.mean500row.pdf",
       width = 6.5, height = 5)
