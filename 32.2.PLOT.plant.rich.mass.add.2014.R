...
write(envi1314, "../2.DX2013_145sites/data/envi1314.all.csv")
...
micro.mass = data.frame(envi$Elevation, cli13$pre.AI, envi$PLFA) 

rownames(micro.mass) = rownames(envi)
...
############## EMF ################
EMF = envi1314[, c("TOC", "TN", "DOC", "DON", "TP")]
...
summary(qu.EMF.AI)
# Adjusted R-squared:  0.5698 p-value: < 2.2e-16
...
############## soil pca1 #################
soil.pca = PCA(EMF, scale.unit=T, graph=F)
summary(soil.pca)
# Dim.1 66.681
...
ggsave("../2.DX2013_145sites/figures/aridity.1314year.mass.rich.EMF.soil.pdf",
          width = 10, height = 5)
