...
coh.all = read.csv("../2.DX2013_145sites/data/All.plant188.micro.soil.1314.cohesion.csv",
                   row.names = 1)
colnames(coh.all)
...
write.csv(hori.all, "../2.DX2013_145sites/data/Total.cohesion.plant184.soil.microbial.1314.CV.Asy.elevation.csv")
...
ggsave("../2.DX2013_145sites/figures/Total.cohesion.plant184.soil.microbial.1314.CV.Asy.pdf",
       width = 6.5, height = 3)


AI.CV.Asy2 = CV.Asy[, c("pre.AI", "net.CV", "net.Asy")]
...
write.csv(AI.hori.all, "../2.DX2013_145sites/data/Total.cohesion.plant184.soil.microbial.1314.CV.Asy.aridity.csv")
...
ggsave("../2.DX2013_145sites/figures/Total.cohesion.plant184.soil.microbial.1314.CV.Asy.aridity.pdf",
       width = 6.5, height = 3)
